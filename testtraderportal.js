 ...
 */
 ...
 var country_data = {"AUSTRALIA": ["ANZ", "BHP", "KAS", "KRMB", "TELS"], "ENGLAND": ["BCL", "BAR", "DAG", "TSCO", "VODA"], "USA": ["APPL", "DRCO", "GOOG", "MSFT", "PLP"], "INDIA": ["BHEL", "ICIC", "IDEA", "RIL", "SUN"], "CHINA": ["ALI", "JIGZ", "SANG", "SOFT", "XOMI"], "GERMANY": ["BMW", "CONT", "DESH", "SMNS", "VWG"], "JAPAN": ["ARZ", "KMC", "NPPO", "SAM", "SONY"]};
